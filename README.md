...
running command...
$ otter (--version)
otter-video-cli/0.5.1 darwin-x64 node-v19.5.0
$ otter --help [COMMAND]
USAGE
  $ otter COMMAND
...
...
_See code: [dist/commands/deploy.ts](https://github.com/otter-framework/otter-cli/blob/v0.5.1/dist/commands/deploy.ts)_
...
_See code: [dist/commands/destroy.ts](https://github.com/otter-framework/otter-cli/blob/v0.5.1/dist/commands/destroy.ts)_
...
_See code: [dist/commands/dev.ts](https://github.com/otter-framework/otter-cli/blob/v0.5.1/dist/commands/dev.ts)_
